...
eu_deadline: "2027-03-18"
type_of_action: "Innovation Action (IA)"
...
| :--- | :--- |
| **Programme** | {{< meta subtitle >}}) |
| **Status** | {{< meta status >}} |
| **Call ID** | {{< meta title >}} |
| **Type Action** | {{< meta type_of_action >}} |
| **Type Grant** | {{< meta grant_type >}} |
| **Target TRL** | {{< meta trl >}} |
| **Planned Opening** | {{< meta opening_date >}} |
| **Closing Date** | {{< meta eu_deadline >}} |
| **Geographic Target** | {{< meta region_scope >}} |
...
### Our Technical Value Proposition
